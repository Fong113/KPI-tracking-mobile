    ...
    <div className='w-full mb-[20px]'>
      ...
      <div className='flex flex-col gap-[30px] w-full px-[20px]'>
        <div className='flex flex-col gap-[20px] w-full '>
          <div className='justify-center text-blue-500 font-semibold text-[24px] w-full flex '>Task hôm nay</div>
      ...
      <div className='flex flex-col items-center mt-[10px]'>
        <div className='justify-center text-blue-500 font-semibold text-[24px]'>Cây của tôi</div>
        <div>
          <img src="tree_2d.png" />
        </div>
      </div>
